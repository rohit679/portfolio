...
const About = ({ setPath }) => {
  ...
  return (
    <div id="home" className="home-section flex flex-col gap-20">
            ...
            <div className="flex flex-col w-full gap-4 lg:px-12">
              {
                isLoading ? (
                  <div className="mx-64 my-4">
                    <Skeleton baseColor="#6e6a6a" highlightColor="#d9d0d0" height={30} />
                  </div>
                ) : (
                  <div className="flex justify-center my-4">
                    <Text size="5xl" classname="capitalize">know who {" "}
          ...
          <div className="flex">
            {
              isLoading ? (
                <div className="w-[20rem]">
                  <Skeleton circle baseColor="#6e6a6a" highlightColor="#d9d0d0" height={320} />
                </div>
              ) : (
                <div>
                  <motion.img 
      ...
      <Container>
        <Text size="2xl" classname="flex justify-center font-semibold mb-6">Education</Text>
      ...
      <Container>
        <div className="flex flex-col gap-8 w-full">
          <div className="flex flex-1 justify-center">
            <Text size="5xl" classname="capitalize">professional <span className="text-baseCol">skillset</span></Text>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-8">
            <SkillCard icon={DiNodejs} size="60" path="https://nodejs.org/en/about/" />
            <SkillCard icon={DiReact} size="60" path="https://reactjs.org/" />
            <SkillCard icon={DiMongodb} size="60" path="https://www.mongodb.com/" />
            <SkillCard icon={DiGit} size="60" path="https://git-scm.com/about" />
            <SkillCard icon={SiNextdotjs} size="60" path="https://nextjs.org/" />
            <SkillCard icon={DiJavascript1} size="60" path="https://www.javascript.com/" />
            <SkillCard icon={DiPython} size="60" path="https://www.python.org/" />
            <SkillCard icon={SiTailwindcss} size="60" path="https://tailwindcss.com/" />
            <SkillCard icon={SiAmazonaws} size="60" path="https://aws.amazon.com/" />
            <SkillCard icon={SiSelenium} size="60" path="https://www.selenium.dev/" />
            <SkillCard icon={CgCPlusPlus} size="60" path="https://isocpp.org/" /> 
            <SkillCard icon={SiExpress} size="60" path="https://expressjs.com/" />
          </div>
        </div>
      </Container>
      <Container>
        <div className="flex flex-col gap-8 w-full">
          <div className="flex flex-1 justify-center">
            <Text size="5xl" classname="capitalize"><span className="text-baseCol">Tools</span> Used</Text>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-8">
            <SkillCard icon={SiPostman} size="60" path="https://www.postman.com/" />
            <SkillCard icon={SiVisualstudiocode} size="60" path="https://code.visualstudio.com/" />
            <SkillCard icon={SiJirasoftware} size="60" path="https://www.atlassian.com/software/jira" />
            <SkillCard icon={SiLinux} size="60" path="https://www.linux.org/" />
            <SkillCard icon={SiMacos} size="60" path="https://www.apple.com/mac/" />
            <SkillCard icon={SiHeroku} size="60" path="https://www.heroku.com/" />  
          </div>
          </div>
      </Container>
      <Container>
        <div className="flex flex-col gap-8 w-full">
          <div className="flex flex-1 justify-center">
            <Text size="5xl" classname="capitalize">day I <span className="text-baseCol">Code</span></Text>
          </div>
